...
const AdminCourseManager = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 h-full overflow-y-auto">
      <h1 className="text-2xl font-bold mb-4">Admin Course Manager</h1>
...
//     try {
//       await axios.delete(
//         `/api/courses/${selectedCourse._id}/videos/${videoId}`
//       );

//       setSelectedCourse({
//         ...selectedCourse,
//         videos: selectedCourse.videos.filter((video) => video._id !== videoId),
//       });
//     } catch (error) {
//       console.error("Failed to delete video:", error);
//     }
